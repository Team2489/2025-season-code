...
public class A_LeftL4 extends SequentialCommandGroup {
  public A_LeftL4(MecanumDriveTrain driveTrain, CoralIntake coralIntake, Elevator elevator, double intakeOutPower) {
    addCommands(
      new A_DriveMec(driveTrain, 0.55, 0.7, 0).withTimeout(1)
      //new ScoreLevelHeight(coralIntake, elevator, ElevatorReefPositions.L4.height, intakeOutPower, limitSwitch)
      );
