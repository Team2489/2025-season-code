...
public class RobotContainer {
  ...
  DriveTrain mDrive = new DriveTrain();
  ...
  public RobotContainer() {
    configureBindings();
    mDrive.setDefaultCommand(new driveMecanum(mDrive, -xboxController.getLeftY(), -xboxController.getLeftX(), -xboxController.getRightX()));
  ...
  private void configureBindings() {
    ...
    // new JoystickButton(xboxController, Button.kA.value).whileTrue(new ScoreLevelHeight(coralIntake, elevator, limitSwitch, ElevatorReefPositions.L1.height, intakeOutPower));
